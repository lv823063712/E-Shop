 ...
 * <p>文件描述：<p>
 * <p>作者：${吕飞}<p>
 * <p>创建时间：2019/1/10   21:29<p>
 * <p>更改时间：2019/1/10   21:29<p>
 * <p>版本号：1<p>
 */

public class AddressAdapter2 extends RecyclerView.Adapter<AddressAdapter2.ViewHolder> {
    private ArrayList<AddressShowData.ResultBean> datas;
    private Context context;


    public AddressAdapter2(ArrayList<AddressShowData.ResultBean> datas, Context context) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.showaddress2, viewGroup, false);
