...
public class MyMLSSAdapter extends RecyclerView.Adapter<MyMLSSAdapter.ViewHolder> {
    private List<MyHotData.ResultBean.MlssBean.CommodityListBeanXX> datas;
    private Context context;
    private View inflate;

    public MyMLSSAdapter(List<MyHotData.ResultBean.MlssBean.CommodityListBeanXX> datas, Context context) {
        this.datas = datas;
