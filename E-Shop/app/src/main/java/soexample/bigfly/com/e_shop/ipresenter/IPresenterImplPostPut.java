...
import soexample.bigfly.com.e_shop.moudle.MyMoudleImplPostPut;
...
public class IPresenterImplPostPut implements IPresenter {
    private IView iView;
    private MyMoudleImplPostPut myMoudle;

    public IPresenterImplPostPut(IView iView) {
        this.iView = iView;
        myMoudle = new MyMoudleImplPostPut();
    }
