...
import soexample.bigfly.com.e_shop.user_defined.AddAndSubtractView;

/**
 * <p>文件描述：<p>
 * <p>作者：${吕飞}<p>
 * <p>创建时间：2019/1/9   16:58<p>
 * <p>更改时间：2019/1/9   16:58<p>
 * <p>版本号：1<p>
 */

public class ShoppingCarAdapter2 extends RecyclerView.Adapter<ShoppingCarAdapter2.ViewHolder> {
    ...
    public ShoppingCarAdapter2(ArrayList<ShoppingCarData.ResultBean> datas, Context context) {
        this.datas = datas;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        inflate = LayoutInflater.from(context).inflate(R.layout.shoppingcar_item2, viewGroup, false);
